...
namespace Alex.API.Gui.Elements
{
    public partial class GuiElement
    {
        ...
        [DebuggerVisible(Category = GuiDebuggerCategories.Layout)] public int Width
        {
            get => _width;
            set
            {
        ...
        [DebuggerVisible(Category = GuiDebuggerCategories.Layout)] public int Height
        {
            get => _height;
            set
            {
        ...
        [DebuggerVisible(Category = GuiDebuggerCategories.Layout)] public int MinWidth
        {
            get => _minWidth;
            set
            {
        ...
        [DebuggerVisible(Category = GuiDebuggerCategories.Layout)] public int MaxWidth
        {
            get => _maxWidth;
            set
            {
        ...
        [DebuggerVisible(Category = GuiDebuggerCategories.Layout)] public int MinHeight
        {
            get => _minHeight;
            set
            {
        ...
        [DebuggerVisible(Category = GuiDebuggerCategories.Layout)] public int MaxHeight
        {
            get => _maxHeight;
            set
            {
        ...
        [DebuggerVisible(Category = GuiDebuggerCategories.Layout)] public Thickness Padding
        {
            get => _padding;
            set
            {
        ...
        [DebuggerVisible(Category = GuiDebuggerCategories.Layout)] public Thickness Margin
        {
            get => _margin;
            set
            {
        ...
        [DebuggerVisible(Category = GuiDebuggerCategories.Layout)] public virtual AutoSizeMode AutoSizeMode
        {
            get => _autoSizeMode;
            set
            {
        ...
        [DebuggerVisible(Category = GuiDebuggerCategories.Layout)] public Alignment Anchor
        {
            get => _anchor;
            set
            {
        ...
        [DebuggerVisible(Category = GuiDebuggerCategories.Layout)] public bool IsSizeDirty { get; protected set; } = true;
        [DebuggerVisible(Category = GuiDebuggerCategories.Layout)] public bool IsLayoutDirty    { get; protected set; } = true;
        
        [DebuggerVisible(Category = GuiDebuggerCategories.Layout)] public bool IsMeasureComplete { get; protected set; } = false;
        [DebuggerVisible(Category = GuiDebuggerCategories.Layout)] public bool IsArrangeComplete { get; protected set; } = false;

        [DebuggerVisible(Category = GuiDebuggerCategories.Layout)] public int  LayoutOffsetX    { get; private set; }   = 0;
        [DebuggerVisible(Category = GuiDebuggerCategories.Layout)] public int  LayoutOffsetY    { get; private set; }   = 0;
        [DebuggerVisible(Category = GuiDebuggerCategories.Layout)] public int  LayoutWidth      { get; private set; }   = 0;
        [DebuggerVisible(Category = GuiDebuggerCategories.Layout)] public int  LayoutHeight     { get; private set; }   = 0;
        [DebuggerVisible(Category = GuiDebuggerCategories.Layout)] public Size PreferredSize    { get; private set; }
        [DebuggerVisible(Category = GuiDebuggerCategories.Layout)] public Size PreferredMinSize { get; private set; }
        [DebuggerVisible(Category = GuiDebuggerCategories.Layout)] public Size PreferredMaxSize { get; private set; }

        #endregion

        #region Calculated Properties

        [DebuggerVisible(Category = GuiDebuggerCategories.Layout)] public Rectangle Bounds      { get; private set; }
        [DebuggerVisible(Category = GuiDebuggerCategories.Layout)] public Rectangle InnerBounds { get; private set; }
        [DebuggerVisible(Category = GuiDebuggerCategories.Layout)] public Rectangle OuterBounds { get; private set; }
        [DebuggerVisible(Category = GuiDebuggerCategories.Layout)] public Point     Position    { get; private set; }
        [DebuggerVisible(Category = GuiDebuggerCategories.Layout)] public Size      Size        { get; private set; }
        [DebuggerVisible(Category = GuiDebuggerCategories.Layout)] public Size      ContentSize { get; private set; }
