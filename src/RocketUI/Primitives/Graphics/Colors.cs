...
namespace RocketUI.Primitives.Graphics
{
		/// <summary>
		...
		public static class Colors
		{
			...
			private static Color FromRgb(int rgb) => Color.FromNonPremultiplied((int)(((rgb >> 16) & 0xff) / 255f), (int)(((rgb >> 8) & 0xff) / 255f), (int) ((rgb & 0xff) / 255f), 255);
			private static Color FromRgb(int r, int g, int b) => Color.FromNonPremultiplied(r, g, b, 255);
			private static Color FromArgb(int argb) => Color.FromNonPremultiplied((int)(((argb >> 16) & 0xff) / 255f), (int)(((argb >> 8) & 0xff) / 255f), (int) ((argb & 0xff) / 255f), (int) (((argb >> 24) & 0xff) / 255f));
			private static Color FromArgb(int r, int g, int b, int a) => Color.FromNonPremultiplied(r, g, b, a);
